...
class PlaylistDetailsScreen extends ConsumerWidget {
            ...
            return ValueListenableBuilder<List<YtifyResult>>(
             ...
             return ValueListenableBuilder(
               ...
               builder: (context, box, _) {
                 ...
                 final storedSongs = downloads.map((d) => YtifyResult.fromJson(Map<String, dynamic>.from(d['result']))).toList();
                 
                 // Combine active first.
                 final allSongs = [...activeSongs, ...storedSongs];
                 
                 return _buildSongList(context, ref, allSongs, storage, progressMap: downloadState.progressMap);
               },
             );
          } else {
  ...
  Widget _buildSongList(BuildContext context, WidgetRef ref, List<YtifyResult> songs, StorageService storage, {Map<String, double>? progressMap}) {
      if (songs.isEmpty) {
        return const Center(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: isDownloading 
                      ? LinearProgressIndicator(value: progress, backgroundColor: Colors.grey[800], valueColor: const AlwaysStoppedAnimation(Color(0xFF1ED760)), minHeight: 4)
                      : Text(
                  ...
                  trailing: IconButton(
                    icon: Icon(
                      playlistName == 'Favorites' ? FluentIcons.heart_24_filled : 
                      ...
                      color: playlistName == 'Favorites' ? const Color(0xFF1ED760) : Colors.grey
                    ),
                    onPressed: () {
                      if (playlistName == 'Favorites') {
